...
use crate::{
    features::auth::{client, state::use_auth, types::AdminInfraResponse},
    routes::paths,
};
use leptos::prelude::*;
    ...
    view! {
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                <A href={paths::USERS} {..} class="group p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:border-blue-500 transition-all">
                ...
                <A href={paths::ORGS} {..} class="group p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:border-blue-500 transition-all">
                    <div class="flex items-center gap-4">
